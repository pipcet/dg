...
$(BUILD)/debian/deb/linux-image.deb: $(BUILD)/debian/deb/Packages dg/deb.pl | $(BUILD)/debian/deb/
	FILE=$$(egrep '^Package: linux-image-(.*)-cloud-arm64-unsigned' < $< | while read DUMMY PACKAGE; do echo $$PACKAGE; done).deb; $(MAKE) -f dg/dg.mk $(BUILD)/debian/deb/$$FILE; ln -sf $$FILE $@
